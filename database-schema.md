...
- `mst_categories` (หมวดหมู่สินค้า — `parent_id` แม่-ลูก, รหัส Parent = 1 ตัวอักษร, Child = 2 ตัวอักษร; Soft Delete `is_active`; จัดการที่ `/settings/master-data?tab=categories`)
...
- `mst_sizes` (ไซส์มาตรฐาน Global Size รวมถึงไซส์บริการ — มีไซส์ `00` สำหรับวัตถุดิบ/งานบริการ; จัดการที่ `/settings/master-data`)
