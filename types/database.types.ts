  ...
  public: {
    Tables: {
      ...
      parameter_change_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "parameter_change_requests_param_key_fkey"
            columns: ["param_key"]
            isOneToOne: false
            referencedRelation: "system_parameters"
      ...
      payment_transactions: {
        Row: {
          ...
          reference_no: string | null
          storage_tier: Database["public"]["Enums"]["storage_tier_type"] | null
          updated_at: string | null
          void_reason: string | null
          voided_at: string | null
          voided_by: string | null
      ...
      product_boms: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_boms_finished_model_id_fkey"
          ...
          {
            foreignKeyName: "product_boms_raw_material_model_id_fkey"
            columns: ["raw_material_model_id"]
            isOneToOne: false
            referencedRelation: "product_models"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "product_boms_uom_id_fkey"
            columns: ["uom_id"]
            isOneToOne: false
            referencedRelation: "mst_uom"
      ...
      product_models: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_models_base_uom_id_fkey"
            columns: ["base_uom_id"]
            isOneToOne: false
            referencedRelation: "mst_uom"
            referencedColumns: ["uom_id"]
      ...
      production_jobs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "production_jobs_product_model_id_fkey"
